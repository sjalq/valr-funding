...
applyQueryResult query result value =
    case ( query, value ) of
        ...
        ( QIndexed index child, VTriple l m r ) ->
            case index of
                0 ->
        ...
        ( QIndexed index child, VDict l ) ->
            l.items
                ...
                |> Maybe.map (\new -> VDict { l | items = List.Extra.setAt index new l.items })
